...
//		}
		...
		jLabel = new JLabel("您要归还的书籍为：");
		jLabel2 = new JLabel(" ");
		jLabel3 = new JLabel("提示操作：请点击选择您要归还的书籍");
		jLabel4 = new JLabel("");
		jLabel5 = new JLabel("当前时间：" + df.format(new Date()));
//		jLabel6 = new JLabel("是否破损：");
//		jLabel7 = new JLabel(" ");

		button0 = new JButton("确定");
		button1 = new JButton("返回");
		button2 = new JButton("无破损");
		button0.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(null, "您所要支付的金额为： " + money + "元");
